...
export default async function AdminInboxPage() {
  ...
  const configAlerts = settings
    ? [
        ...
        !settings["payment.transferNumber"].trim() && t("رقم التحويل فارغ — العملاء ما يگدرون يدفعون من صفحة الطلب.", "The transfer number is empty — customers can't pay for their orders."),
      ].filter(Boolean)
    : [];
