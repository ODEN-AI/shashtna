...
export type StorageHash =
  StorageHashBase<'015a5832697de1be26de4c7d49e81af3fa770ab6ebb1479f7d7081bb1b439d22'>;
export type ExecutionHash =
  ExecutionHashBase<'18855ca79e5a0925186692f494433125bb57c6fbd823ed5cd0df4789417a9355'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly PushCampaign: {
      ...
      readonly deviceCount: CodecTypes['pg/int4@1']['output'];
      readonly acceptedCount: CodecTypes['pg/int4@1']['output'];
    ...
    readonly PushTicket: {
      ...
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly checkedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
    };
    readonly Receipt: {
      readonly id: CodecTypes['pg/int4@1']['output'];
    ...
    readonly User: {
      ...
      readonly failedLogins: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly PushCampaign: {
      ...
      readonly deviceCount: CodecTypes['pg/int4@1']['input'];
      readonly acceptedCount: CodecTypes['pg/int4@1']['input'];
    ...
    readonly PushTicket: {
      ...
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly checkedAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
    };
    readonly Receipt: {
      readonly id: CodecTypes['pg/int4@1']['input'];
    ...
    readonly User: {
      ...
      readonly failedLogins: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly pushCampaign: {
              ...
              indexes: readonly [
                {
                  readonly name: 'pushCampaign_status_idx_e98638ab';
                  readonly prefix: 'pushCampaign_status_idx';
            ...
            readonly pushDevice: {
              columns: {
                ...
                readonly provider: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'EXPO'>;
                  };
                };
                readonly platform: {
                  readonly nativeType: 'text';
            ...
            readonly pushTicket: {
              ...
              indexes: readonly [
                {
                  readonly name: 'pushTicket_status_idx_e98638ab';
                  readonly prefix: 'pushTicket_status_idx';
                  readonly columns: readonly ['status'];
                  readonly unique: false;
                },
              ];
...
> & {
  ...
  readonly roots: {
    ...
    readonly pushCampaign: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'PushCampaign';
    };
    readonly pushTicket: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'PushTicket';
    };
    readonly announcement: {
      readonly namespace: 'public' & NamespaceId;
          ...
          readonly PushCampaign: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly deviceCount: { readonly column: 'deviceCount' };
                readonly acceptedCount: { readonly column: 'acceptedCount' };
          ...
          readonly User: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly failedLogins: { readonly column: 'failedLogins' };
